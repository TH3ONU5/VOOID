                    ...
                    <div class="card shadow border-0 mb-7">
                        ...
                        <div class="p-1em">
                            <form action="" method="post">
                                <div class="gap-2em d-flex-nrespons">
                                    <input type="text" class="ip-lus" name="firstname" placeholder="Firstname" autocomplete="off" required>
                                    <input type="text" class="ip-lus" name="lastname" placeholder="Lastname" autocomplete="off" required>
                                </div>
                                <br>
                                <div>
                                    <input type="submit" name="search" class="se-sb">
                                </div>
                            </form>
                        </div>
                    </div>
                            ...
                            <table class="table table-hover table-nowrap">
                                ...
                                <tbody>
                                    ...
                                    if (isset($_POST['search'])) {
                                        ...
                                        {
                                            return htmlspecialchars((stripslashes(strip_tags($data))));
                                        }

                                        $firstname = clean_input($_POST['firstname']);
                                        $lastname = clean_input($_POST['lastname']);

                                        $stmt = $conn->prepare("SELECT id, lastname, firstname, send, company, status, paid FROM contact WHERE firstname = ? AND lastname = ?");
