        ...
        <section class="relative z-10 pt-30 lg:pt-35 xl:pt-40 pb-18">
            ...
            <div class="text-center px-4">
                ...
                <ul class="flex items-center justify-center gap-2">
                    ...
                    <li class="font-medium">/ AI-Assistent</li>
                </ul>
            </div>
        </section>
        ...
        <section class="pt-17.5 lg:pt-22.5 xl:pt-27.5 pb-20 lg:pb-25 xl:pb-30 2xl:pb-[150px]">
            <div class="wow fadeInUp mx-auto w-full max-w-[597px] text-center px-4 sm:px-8 lg:px-0" data-wow-delay="0.1s">
                ...
                <p class="font-medium mb-9">
                    Our AI assistant is currently under development and will be available online soon. Our goal is to revolutionize the traditional FAQ page by replacing it with a dynamic AI assistant. This will enable our customers to receive instant answers to their questions without the need to manually search through pages.
                </p>
                <a href="../homepage/index.php" class="hero-button-gradient inline-flex rounded-lg py-3 px-7 text-white font-medium ease-in duration-300 hover:opacity-80">
                    Go to Homepage
                </a>
            </div>
        </section>
