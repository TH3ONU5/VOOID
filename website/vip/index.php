                        ...
                        <div class="relative rounded-3xl features-box-border">
                            <div class="relative overflow-hidden rounded-3xl px-11 pt-12.5 pb-14 box-hover box-hover-small">
                                <div class="relative z-20">
                                    ...
                                    <p class="font-medium">
                                        The VIP package is ideal for anyone for whom the Premium package is not enough and who needs additional functions. It not only includes advanced features, but also the ability to have a website edited quickly. In addition, users benefit from numerous other advantages, such as preferential treatment when creating their website and 24/7 support.
                                    </p>
                                </div>
                            ...
                            <div class="relative overflow-hidden rounded-3xl px-11 pt-12.5 pb-14 box-hover box-hover-small">
                                <div class="relative z-20">
                                    ...
                                    <ul class="flex flex-col gap-4">
                                        ...
                                        <li class="flex items-center gap-5">
                                            <img src="../../images/pricing-icon-04.svg" alt="icon">
                                            <span class="font-medium">5 - 6 functions</span>
                                        </li>
                                        <li class="flex items-center gap-5">
                                            <img src="../../images/pricing-icon-04.svg" alt="icon">
                                            <span class="font-medium">10 month web administration </span>
                                        </li>
                                        <li class="flex items-center gap-5">
                                            <img src="../../images/pricing-icon-04.svg" alt="icon">
