        ...
        <section class="relative z-10 pt-30 lg:pt-35 xl:pt-40 pb-18">
            ...
            <div class="text-center px-4">
                <h1 class="font-extrabold text-heading-2 text-white mb-5.5">
                    Website Premium Package
                </h1>
                <ul class="flex items-center justify-center gap-2">
                    <li class="font-medium"><a href="../../index.html">Homepage</a></li>
                    <li class="font-medium">/ Website Premium Package</li>
                </ul>
            </div>
        </section>
                        ...
                        <div class="relative rounded-3xl features-box-border">
                            <div class="relative overflow-hidden rounded-3xl px-11 pt-12.5 pb-14 box-hover box-hover-small">
                                <div class="relative z-20">
                                    ...
                                    <p class="font-medium">
                                        The Premium package is an excellent choice for everyone. It includes everything you need, including exclusive features that will make your website stand out from the rest. Additionally, it comes at an unbeatable price, making it a cost-effective option for all users who want to get the most out of it. With the Premium package, you benefit from first-class support, regular updates and many other advantages.
                                    </p>
                                </div>
                                ...
                                <div class="relative z-20">
                                    ...
                                    <ul class="flex flex-col gap-4">
                                        <li class="flex items-center gap-5">
                                            ...
                                            <span class="font-medium">Design post-selection</span>
                                        </li>
                                        <li class="flex items-center gap-5">
                                            <img src="../../images/pricing-icon-04.svg" alt="icon">
