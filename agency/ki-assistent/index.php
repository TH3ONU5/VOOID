...
<head>
    ...
    <title>VOOID | KI-Assistent</title>
        ...
        <section class="relative z-10 pt-30 lg:pt-35 xl:pt-40 pb-18">
            ...
            <div class="text-center px-4">
                ...
                <ul class="flex items-center justify-center gap-2">
                    <li class="font-medium"><a href="index.php">Startseite</a></li>
                    <li class="font-medium">/ KI-Assistent</li>
                </ul>
            </div>
        </section>
        ...
        <section class="pt-17.5 lg:pt-22.5 xl:pt-27.5 pb-20 lg:pb-25 xl:pb-30 2xl:pb-[150px]">
            <div class="wow fadeInUp mx-auto w-full max-w-[597px] text-center px-4 sm:px-8 lg:px-0" data-wow-delay="0.1s">
                ...
                <h2 class="mb-5.5 text-heading-3 font-bold text-white">
                    KI-Assistent im Entwicklung
                </h2>
                <p class="font-medium mb-9">
                    Unser KI-Assistent befindet sich derzeit noch in der Entwicklungsphase, und es wird noch einige Zeit dauern, bis er online verfügbar ist. Unser Ziel ist es, die herkömmliche FAQ-Seite durch unseren KI-Assistenten zu ersetzen. Dadurch können unsere Kunden ihre Fragen direkt beantworten lassen, ohne selbst nach den Antworten suchen zu müssen. </p>
