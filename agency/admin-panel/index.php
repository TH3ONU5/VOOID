...
// Datumnbankverbindungsdetails
$server = "localhost";
$username = "root";
$password = "";
$dbname = "agencyDB";

// Stelle eine Verbindung zur Datumnbank her
...
// Bereite eine SQL-Abfrage vor, um die Session-ID aus der Datumnbank abzurufen
...
// Verarbeite die Anfrage zum Löschen von Datumn
if (isset($_POST['delete'])) {
    // Bereinige und validiere die Benutzer-ID
    $user_id = intval($_POST['user_id']);

    // Stelle die Datumnbankverbindung erneut her
    $conn = new mysqli($server, $username, $password, $dbname);
    ...
    // Bereite die SQL-Anweisung zum Löschen der Datumn vor
    $sql = "UPDatum contact SET display = ? WHERE id = ?";
    $stmt = $conn->prepare($sql);
    ...
    if ($stmt->execute()) {
        ...
        echo "<div id='success'>";
        echo "<div id=''><span>Datumn mit der ID " . $user_id . " erfolgreich gelöscht</span></div>";
        echo "</div>";
    ...
    // Schließe das Statement zum Löschen der Datumn
    $stmt->close();
    // Schließe die Datumnbankverbindung
    $conn->close();
}
?>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="sidebarCollapse">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="unbekannt.php">
                                ...
                                <span class="badge bg-soft-primary text-primary rounded-pill d-inline-flex align-items-center ms-auto">
                                    ...
                                    // Prepare SQL query to count unbekannt
                                    ...
                                    // Fetch row and get the count of unbekannt
                                    $row = $result->fetch_assoc();
                    ...
                    <ul class="navbar-nav mb-md-4">
                        ...
                        // Prepare SQL query to select latest unbekannt
                        ...
                        ?>
                            <li>
                                <a href="unbekannt.php#<?php echo $user_id; ?>" class="nav-link d-flex align-items-center">
                                    <div class="me-4">
