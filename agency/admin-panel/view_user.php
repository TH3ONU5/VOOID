...
// Funktionalität zum Setzen des Status auf "Done"
...
// Funktionalität für "In progress"
...
if (isset($_POST['payed'])) {
    ...
    // Überprüfe den aktuellen Zahlungsstatus
    ...
    // Wenn der aktuelle Status grün ist, ändere ihn in rot und umgekehrt
                ...
                <div class="navbar-user d-lg-none">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="sidebarAvatar">
                            <a href="#" class="dropdown-item">Dahsboard</a>
                            <a href="#" class="dropdown-item">Unbekannt</a>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <span class="h3 font-bold mb-0">
                                                ...
                                                $sql = "SELECT COUNT(*) AS num_rows FROM contact WHERE status = 'In bearbeitung'";
                                                $stmt = $conn->prepare($sql);
                            ...
                            <table class="table table-hover table-nowrap">
                                ...
                                <tbody>
                                    ...
                                    if (isset($_GET['user_id'])) {
                                        ...
                                        // Vorbereiten und Ausführen der SQL-Abfrage mit Prepared Statements
                                        ...
                                        // Überprüfen, ob Zeilen zurückgegeben wurden
                                        if ($result->num_rows > 0) {
                                            $row = $result->fetch_assoc();
                                            $firstname_letter = substr($row["firstname"], 0, 1);
                                            $lastname_letter = substr($row["lastname"], 0, 1);
