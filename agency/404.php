        ...
        <div class="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0 lg:flex items-center justify-between relative">
            ...
            <div class="w-full lg:w-3/4 h-0 lg:h-auto invisible lg:visible lg:flex items-center justify-between" :class="{ '!visible bg-dark shadow-lgrelative !h-auto max-h-[400px] overflow-y-scroll rounded-md mt-4 p-7.5': navigationOpen }">
                <nav>
                    <ul class="flex lg:items-center flex-col lg:flex-row gap-5 lg:gap-2">
                        <li class="nav__menu lg:py-7 lg:!py-4" :class="{ 'lg:!py-4' : stickyMenu }">
                            <a href="./index.php/#startseite" class="relative text-white/80 text-sm py-1.5 px-4 border border-transparent hover:text-white hover:nav-gradient">Startseite</a>
                        </li>
                        <li class="nav__menu lg:py-7 lg:!py-4" :class="{ 'lg:!py-4' : stickyMenu }">
                        ...
                        <li class="nav__menu lg:py-7 lg:!py-4" :class="{ 'lg:!py-4' : stickyMenu }">
                            <a href="./index.php#support" class="relative text-white/80 text-sm py-1.5 px-4 border border-transparent hover:text-white hover:nav-gradient">Kontaktieren</a>
                        </li>
                        <li class="nav__menu lg:py-7 lg:!py-4" :class="{ 'lg:!py-4' : stickyMenu }">
                ...
                <div class="flex items-center gap-6 mt-7 lg:mt-0">
                    <a href="./ki-assistent" class="button-border-gradient relative rounded-lg text-white text-sm flex items-center gap-1.5 py-2 px-4.5 shadow-button hover:button-gradient-hover hover:shadow-none">KI-Assistent</a>
                </div>
            </div>
        </div>
    </header>
        ...
        <section class="relative z-10 pt-30 lg:pt-35 xl:pt-40 pb-18">
            ...
            <div class="text-center px-4">
                <h1 class="font-extrabold text-heading-2 text-white mb-5.5">
                    Seite nicht gefunden <strong>404</strong>
                </h1>
                <ul class="flex items-center justify-center gap-2">
                    <li class="font-medium"><a href="index.php">Home</a></li>
                    <li class="font-medium">/ Seite nicht gefunden <strong>404</strong></li>
                </ul>
            </div>
        </section>
        ...
        <section class="pt-17.5 lg:pt-22.5 xl:pt-27.5 pb-20 lg:pb-25 xl:pb-30 2xl:pb-[150px]">
            <div class="wow fadeInUp mx-auto w-full max-w-[597px] text-center px-4 sm:px-8 lg:px-0" data-wow-delay="0.1s">
                ...
                <p class="font-medium mb-9">
                    Die von ihnen gesuchte Seite ist nicht verfügbar oder wurde verschoben. Versuchen Sie eine andere Seite oder gehen Sie mit dem unten stehenden Button zur Startseite.
                </p>
                    ...
                    <div class="flex flex-col sm:flex-row sm:justify-between gap-10">
                        <div>
                            ...
                            <ul class="flex flex-col gap-3.5">
                                ...
                                <li>
                                    <a href="./index.php#preise" class="font-medium ease-in duration-300 hover:text-white">Preise</a>
                                </li>
                                <li>
                                    <a href="./index.php#warum-wir" class="font-medium ease-in duration-300 hover:text-white">Warum
                                        wir</a>
                                </li>
                                <li>
                                    <a href="./index.php#kontaktieren" class="font-medium ease-in duration-300 hover:text-white">Kontaktieren</a>
                                </li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <ul class="flex flex-col gap-3.5">
                                ...
                                <li>
                                    <a href="./datenschutz/" class="font-medium ease-in duration-300 hover:text-white">Datenschutzbedingungen</a>
                                </li>
                            </ul>
                        </div>
                        <div>
