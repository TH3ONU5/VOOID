                ...
                <nav>
                    <ul class="flex lg:items-center flex-col lg:flex-row gap-5 lg:gap-2">
                        <li class="nav__menu lg:py-7 lg:!py-4" :class="{ 'lg:!py-4' : stickyMenu }">
                            <a href=".././#startseite" class="relative text-white/80 text-sm py-1.5 px-4 border border-transparent hover:text-white hover:nav-gradient">Startseite</a>
                        </li>
                        <li class="nav__menu lg:py-7 lg:!py-4" :class="{ 'lg:!py-4' : stickyMenu }">
                        ...
                        <li class="nav__menu lg:py-7 lg:!py-4" :class="{ 'lg:!py-4' : stickyMenu }">
                            <a href=".././#support" class="relative text-white/80 text-sm py-1.5 px-4 border border-transparent hover:text-white hover:nav-gradient">Kontaktieren</a>
                        </li>
                        <li class="nav__menu lg:py-7 lg:!py-4" :class="{ 'lg:!py-4' : stickyMenu }">
                            <a href=".././über" class="relative text-white/80 text-sm py-1.5 px-4 border border-transparent hover:text-white hover:nav-gradient !text-white nav-gradient" :class="{'!text-white nav-gradient' :page === 'about'}">Team & Services</a>
                        </li>
                    </ul>
                </nav>
            ...
            <div class="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0 py-20 lg:py-25 relative">
                ...
                <div class="flex gap-11 flex-wrap justify-between">
                    <div class="wow fadeInLeft max-w-[570px] w-full">
                        <span class="hero-subtitle-text font-semibold block mb-5">Über uns & unseren Service</span>
                        ...
                        <p class="mb-9 font-medium">
                            Wenn Sie mehr über uns und unser Angebot erfahren möchten, empfehlen wir Ihnen, das untenstehende Video anzusehen. Leider befindet sich unser KI-Assistent noch in Entwicklung und ist daher noch nicht einsatz bereit.</p>
                ...
                <div class="cta-box-gradient bg-dark rounded-[30px] relative overflow-hidden px-4 py-20 lg:py-25 z-999">
                    ...
                    <div class="wow fadeInUp text-center" style="visibility: visible;">
                        ...
                        <p class="max-w-[714px] mx-auto font-medium mb-9">
                            Wir erstellen Ihre Traum-Website, damit Sie im Internet besser sichtbar werden und eine stärkere Präsenz zeigen können.
                        </p>
                        <a href="./#pricing" class="hero-button-gradient inline-flex rounded-lg py-3 px-7 text-white font-medium ease-in duration-300 hover:opacity-80">
                            Jetzt loslegen
                        </a>
                    </div>
                </div>
