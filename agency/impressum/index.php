        ...
        <section class="relative z-10 pt-30 lg:pt-35 xl:pt-40 pb-18">
            ...
            <div class="text-center px-4">
                ...
                <ul class="flex items-center justify-center gap-2">
                    ...
                    <li class="font-medium">/ Impressum</li>
                </ul>
            </div>
        </section>
        ...
        <section class="relative overflow-hidden pb-17.5 lg:pb-22.5 xl:pb-27.5 pt-20 lg:pt-25" id="faq">
            ...
            <div class="max-w-[770px] mx-auto px-4 sm:px-8 xl:px-0">
                <div class="max-w-[870px] mx-auto">
                    ...
                    <p class="font-medium mb-6">
                        Vielen Dank für Ihren Besuch auf unserer Website. Wir freuen uns über Ihr Interesse an unseren Dienstleistungen. Bitte beachten Sie, dass sich unsere Website derzeit im Aufbau befindet. Wir arbeiten hart daran, es zu verbessern und Ihnen ein großartiges Erlebnis zu bieten. Wir sind jedoch voll einsatzbereit und bereit, Ihnen zu helfen! Kontaktieren Sie uns gerne, um Ihre Webdesign-Anforderungen zu besprechen und uns mit der Erstellung Ihrer individuellen Website zu beauftragen. Nehmen Sie noch heute Kontakt mit uns auf, um mehr zu erfahren und Ihr Projekt anzukurbeln! Danke für ihr Verständnis und ihre Geduld.
                    </p>
