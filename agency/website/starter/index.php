                ...
                <nav>
                    <ul class="flex lg:items-center flex-col lg:flex-row gap-5 lg:gap-2">
                        <li class="nav__menu lg:py-7 lg:!py-4" :class="{ 'lg:!py-4' : stickyMenu }">
                            <a href="../.././#startseite"
                                class="relative text-white/80 text-sm py-1.5 px-4 border border-transparent hover:text-white hover:nav-gradient">Stratseite</a>
                        </li>
                        <li class="nav__menu lg:py-7 lg:!py-4" :class="{ 'lg:!py-4' : stickyMenu }">
                            <a href="../.././#warum-wir"
        ...
        <section class="relative z-10 pt-30 lg:pt-35 xl:pt-40 pb-18">
            ...
            <div class="text-center px-4">
                ...
                <ul class="flex items-center justify-center gap-2">
                    ...
                    <li class="font-medium">/ Website Starter-Paket</li>
                </ul>
            </div>
        </section>
                        ...
                        <div class="relative rounded-3xl features-box-border">
                            <div
                                ...
                                <div class="relative z-20">
                                    ...
                                    <p class="font-medium">
                                        Das Starter-Paket ist ideal für Privat-personen, da es kosteneffizient,
                                        benutzerfreundlich und kompakt ist. Es bietet eine Funktion bei dem sie
                                        auswählen können was es wird.
                                    </p>
                                </div>
                            ...
                            <div
                                ...
                                <div class="relative z-20">
                                    ...
                                    <ul class="flex flex-col gap-4">
                                        ...
                                        <li class="flex items-center gap-5">
                                            <img src="../../images/pricing-icon-04.svg" alt="icon">
                                            <span class="font-medium">2 Monate Hosting (Kostenlose)</span>
                                        </li>
                                        <li class="flex items-center gap-5">
                                            <img src="../../images/pricing-icon-04.svg" alt="icon">
                                            <span class="font-medium">3 Unterseiten</span>
                                        </li>
                                    </ul>
                                </div>
...
if (isset($_POST['submit'])) {
    ...
    if (empty($errors)) {
        ...
        $sql = "INSERT INTO contact (firstname, lastname, company, phone, email, message, send, status, starter)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
        $stmt = $conn->prepare($sql);
