...
<body x-data="{ page: 'premium', 'loaded': true, 'stickyMenu': false, 'navigationOpen': false, 'scrollTop': false }">
                ...
                <nav>
                    <ul class="flex lg:items-center flex-col lg:flex-row gap-5 lg:gap-2">
                        <li class="nav__menu lg:py-7 lg:!py-4" :class="{ 'lg:!py-4' : stickyMenu }">
                            <a href="../.././#startseite"
                                class="relative text-white/80 text-sm py-1.5 px-4 border border-transparent hover:text-white hover:nav-gradient">Startseite</a>
                        </li>
                        <li class="nav__menu lg:py-7 lg:!py-4" :class="{ 'lg:!py-4' : stickyMenu }">
                            <a href="../.././#warum-wir"
        ...
        <section class="relative z-10 pt-30 lg:pt-35 xl:pt-40 pb-18">
            ...
            <div class="text-center px-4">
                <h1 class="font-extrabold text-heading-2 text-white mb-5.5">
                    Website Premium-Paket
                </h1>
                <ul class="flex items-center justify-center gap-2">
                    <li class="font-medium"><a href="../../index.html">Startseite</a></li>
                    <li class="font-medium">/ Website Premium-Paket</li>
                </ul>
            </div>
        </section>
                        ...
                        <div class="relative rounded-3xl features-box-border">
                            <div
                                ...
                                <div class="relative z-20">
                                    ...
                                    <p class="font-medium">
                                        Das Premium-Paket ist eine hervorragende Wahl für jedermann. Es enthält alles,
                                        was man braucht, einschließlich exklusiver Funktionen, die Ihre Website von den
                                        anderen Websites hervorhebt. Zusätzlich wird es zu einem unschlagbaren Preis
                                        angeboten, was es zu einer kosteneffizienten Option für alle Nutzer macht, die
                                        das Beste herausholen möchten. Mit dem Premium-Paket profitieren Sie von
                                        erstklassigem Support, regelmäßigen Updates und vielen weiteren Vorteilen.
                                    </p>
                                </div>
                                ...
                                <div class="relative z-20">
                                    ...
                                    <ul class="flex flex-col gap-4">
                                        <li class="flex items-center gap-5">
                                            ...
                                            <span class="font-medium">Design-Nachwahl</span>
                                        </li>
                                        <li class="flex items-center gap-5">
                                            <img src="../../images/pricing-icon-04.svg" alt="icon">
                                        ...
                                        <li class="flex items-center gap-5">
                                            <img src="../../images/pricing-icon-04.svg" alt="icon">
                                            <span class="font-medium">Funktion =&gt; 3</span>
                                        </li>
                                        <li class="flex items-center gap-5">
                                            <img src="../../images/pricing-icon-04.svg" alt="icon">
                                            <span class="font-medium">5 Monate Hosting (Kostenlose)</span>
                                        </li>
                                        <li class="flex items-center gap-5">
                                            <img src="../../images/pricing-icon-04.svg" alt="icon">
                                            <span class="font-medium">7 Unterseiten</span>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="w-full px-4 xl:px-5">
                                    <div class="mb-9.5">
                                        ...
                                        <input type="text" id="company" name="company"
                                            placeholder="Geben Sie Ihren Firmenname ein" rows="6"
                                            class="rounded-lg border border-white/[0.12] bg-white/[0.05] focus:border-purple w-full py-3 px-6 outline-none"
                                            autocomplete="off" required>
                                    </div>
                                </div>
                                <div class="w-full px-4 xl:px-5 md:w-1/2">
                                    <div class="mb-9.5">
                                        ...
                                        <input id="phone" type="tel" name="phone"
                                            placeholder="Geben Sie Ihren Telefonnummer ein"
                                            class="rounded-lg border border-white/[0.12] bg-white/[0.05] focus:border-purple w-full py-3 px-6 outline-none"
                                            autocomplete="off" required>
                                    </div>
                                </div>
                                ...
                                <div class="w-full px-4 xl:px-5">
                                    <div class="mb-10">
                                        ...
                                        <textarea id="message" name="message"
                                            placeholder="Geben Sie Ihren Nachricht ein" rows="6"
                                    ...
                                    <div class="mb-10 d-flex align-items-baseline gap-10px">
                                        ...
                                        <label for="therms" class="text-white mb-2.5 block font-medium">
                                            ...
                                            <a href="../../datenschutzrichtlinien/" target="_blank"
                                                class="underline-dashed fs-italic">
...
if (isset($_POST['submit'])) {
    ...
    if (empty($errors)) {
        ...
        $sql = "INSERT INTO contact (firstname, lastname, company, phone, email, message, send, status, premium)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
        $stmt = $conn->prepare($sql);
