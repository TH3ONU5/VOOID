        ...
        <section class="relative z-10 pt-30 lg:pt-35 xl:pt-40 pb-18">
            ...
            <div class="text-center px-4">
                ...
                <ul class="flex items-center justify-center gap-2">
                    ...
                    <li class="font-medium">/ Website VIP-Paket</li>
                </ul>
            </div>
        </section>
                        ...
                        <div class="relative rounded-3xl features-box-border">
                            <div
                                ...
                                <div class="relative z-20">
                                    ...
                                    <p class="font-medium">
                                        Das VIP-Paket ist ideal für alle, denen das Premium-Paket nicht ausreicht und
                                        die zusätzliche Funktionen benötigen. Es umfasst nicht nur erweiterte Features,
                                        sondern auch die Möglichkeit, eine Website schnell bearbeiten zu lassen. Darüber
                                        hinaus profitieren Nutzer von zahlreichen weiteren Vorteilen, wie bevorzugter
                                        Behandlung bei der Erstellung ihrer Website und einem 24/7 Support.
                                    </p>
                                </div>
                            ...
                            <div
                                ...
                                <div class="relative z-20">
                                    ...
                                    <ul class="flex flex-col gap-4">
                                        ...
                                        <li class="flex items-center gap-5">
                                            <img src="../../images/pricing-icon-04.svg" alt="icon">
                                            <span class="font-medium">9 Monate Hosting (Kostenlose)</span>
                                        </li>
                                        <li class="flex items-center gap-5">
                                            <img src="../../images/pricing-icon-04.svg" alt="icon">
...
if (isset($_POST['submit'])) {
    ...
    if (empty($errors)) {
        ...
        $sql = "INSERT INTO contact (firstname, lastname, company, phone, email, message, send, status, vip)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?,?)";
        $stmt = $conn->prepare($sql);
